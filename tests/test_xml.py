...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("tests/fixtures/deid_3.xml", "PhilipsECG", "1.04"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "tests/fixtures/invalid-doc-type.xml",
            "Files of type MortaraECG 1.03 are unsupported",
        ),
        (
            "tests/fixtures/invalid-doc-version.xml",
            "Files of type SierraECG 1.05 are unsupported",
        ),
    ],
)
